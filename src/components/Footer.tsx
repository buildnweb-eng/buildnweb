        ...
        <div className="grid lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="text-3xl font-bold gradient-text">Buildnweb</div>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              Transforming ideas into powerful digital experiences. We
              specialize in web applications, mobile apps, desktop software, and
              college projects with cutting-edge technology.
            </p>
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-white/10 hover:bg-gray-800 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110"
              >
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 mb-4 md:mb-0">
              <p>&copy; 2025 Buildnweb. All rights reserved.</p>
            </div>
